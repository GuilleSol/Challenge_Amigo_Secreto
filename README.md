...
- ✍️**Agregar nombres:** Los usuarios pueden ingresar nombres en un campo de texto y hacer clic en **"Añadir"** para agregarlos a la lista.
   ...
   ![Agregar nombre](https://raw.githubusercontent.com/TU_USUARIO/TU_REPOSITORIO/main/assets-readme2/funcion1.png)

- ❗**Validación de entrada:** Si el campo de texto está vacío o contiene caracteres no válidos, el sistema mostrará una alerta solicitando un nombre válido.

   ![Alerta de validación](https://raw.githubusercontent.com/TU_USUARIO/TU_REPOSITORIO/main/assets-readme2/funcion2.png)

- 👀**Visualización dinámica:** Los nombre
